...
public class SendMessageServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        String broker = "tcp://broker.hivemq.com"; // Đổi lại địa chỉ HiveMQ server của bạn
        String clientId = "clientId-CDenOHTrcu"; // Đổi lại client ID của bạn
        try {
            ...
            client.publish("LEDCONTROL", mqttMessage); // Đổi lại topic của bạn
            client.disconnect();
