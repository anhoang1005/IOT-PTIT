<%-- 
    Document   : home.jsp
    Created on : Sep 3, 2023, 3:39:13 PM
    Author     : Hoang Van An
--%>
...
<html lang="en">
    ...
    <body class="fixed-navbar">
                                ...
                                <div class="col-lg-12 col-md-6" >
                                    <div id="flashingDiv1" class="ibox bg-white color-white widget-stat flashing" style="border: 4px solid green">
                                        <div class="ibox-body">
                                            ...
                                            <center><button onclick="logEvent(1, 'ON')" class="btn btn-success" id="onButtonquat">ON</button> <button onclick="logEvent(1, 'OFF')" class="btn btn-danger" id="offButtonquat">OFF</button></center> 
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-md-6">
        ...
        <script src="./javascript/home_sendmess.js" type="text/javascript"></script>
    </body>
</html>
<style>
    .flashing {
